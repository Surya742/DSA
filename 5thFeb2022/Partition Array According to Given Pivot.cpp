...
// new position of the jth element. For elements less than pivot, if i < j and nums[i] < pivot and nums[j] < pivot, 
// then pi < pj. Similarly for elements greater than pivot, if i < j and nums[i] > pivot and nums[j] > pivot, then pi < pj.
// Return nums after the rearrangement.

// Prob Link: https://leetcode.com/problems/partition-array-according-to-given-pivot/
